...
class MinuteVentilationAdjusted:

    def __init__(self, input_path, output_path):
        self.__file_path = input_path + '/minute_ventilation_adjusted.wav'
        ...
        print(colored('The minute_ventilation_adjusted data are fully imported.', 'green'))
    ...
    def export_csv(self):
        ...
        # Generate the CSV
        with open(self.__output_path + '/minute_ventilation_adjusted.csv', 'w', newline='') as csvfile:
            filewriter = csv.writer(csvfile, dialect='excel')
            filewriter.writerow(['TimeCode', 'MinuteVentilationAdjusted(mL/min)'])
