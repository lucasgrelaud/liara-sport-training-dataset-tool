...
class VideoPlayerWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.__rotate_left_button.setIcon(self.style().standardIcon(QStyle.SP_ArrowBack))
        ...
        self.__rotate_right_button.setIcon(self.style().standardIcon(QStyle.SP_ArrowForward))
        ...
        bottom_control_layout.addWidget(self.time_code)
        ...
        self.media_player.setVideoOutput(self.__video_item)
        self.media_player.stateChanged.connect(self.__media_state_changed)
        self.media_player.positionChanged.connect(self.__position_changed)
        self.media_player.durationChanged.connect(self.__duration_changed)
